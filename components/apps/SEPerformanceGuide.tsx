        ...
        <aside className="no-print w-full md:w-72 border-b md:border-b-0 md:border-r border-zinc-800 bg-zinc-950 flex flex-col shrink-0 z-30">
           <div className="p-8 flex items-center gap-3">
              ...
              <div className="flex flex-col">
                  ...
                  <span className="text-[10px] font-mono text-zinc-600 uppercase tracking-widest mt-1">v1.0</span>
              </div>
           </div>
           ...
           <div className="max-w-4xl mx-auto space-y-20 animate-fade-in pb-32">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                  <div className="p-8 bg-zinc-900/50 border border-zinc-800 rounded-3xl">
                      ...
                      <p className="text-zinc-400 text-sm leading-relaxed">The SE Performance Guide treats the body as a hierarchical state machine. Rhythms (Circadian) govern energy levels, which govern focus (Ultradian), which determines cognitive output.</p>
                  </div>
                  <div className="p-8 bg-zinc-900/50 border border-zinc-800 rounded-3xl">
