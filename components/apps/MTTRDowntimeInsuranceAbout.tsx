...
export const MTTRDowntimeInsuranceAbout: React.FC<MTTRDowntimeInsuranceAboutProps> = ({ onBack, onNavigate }) => {
  return (
    <div className="min-h-screen bg-page-bg text-primary flex flex-col relative overflow-hidden">
      ...
      <header className="h-16 border-b border-border flex items-center justify-between px-6 bg-page-bg/85 backdrop-blur z-20 shadow-[0_10px_30px_-22px_rgba(0,0,0,0.9)]">
        <div className="flex items-center gap-4">
          ...
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <span className="tool-label mt-1 block">Downtime Risk and Recovery Model</span>
            </div>
          </div>
        </div>
        {onNavigate && (
      ...
      <main className="flex-1 p-6 md:p-12 space-y-10 relative z-10">
        <section className="grid grid-cols-1 lg:grid-cols-[1.2fr,0.8fr] gap-6">
          <div className="p-8 rounded-[2.5rem] border border-border bg-card-bg/80 shadow-[0_25px_60px_-40px_rgba(0,0,0,0.85)] space-y-5">
            ...
            <p className="text-base md:text-lg text-primary leading-relaxed max-w-2xl">
            ...
            <div className="flex flex-wrap gap-2 text-[11px] font-mono uppercase tracking-[0.3em] text-secondary">
              ...
              <span className="px-3 py-1 rounded-full border border-border bg-card-bg">Scenario Presets</span>
              <span className="px-3 py-1 rounded-full border border-border bg-card-bg">Annualized View</span>
            </div>
          </div>
          <div className="p-6 rounded-[2.5rem] border border-border bg-card-bg/70 shadow-[0_25px_60px_-40px_rgba(0,0,0,0.85)] space-y-4">
            <div className="flex items-center gap-2 text-[11px] font-semibold uppercase tracking-[0.3em] text-secondary">
        ...
        <section className="grid grid-cols-1 md:grid-cols-3 gap-4">
          <div className="p-6 rounded-[2rem] border border-border bg-card-bg/80 shadow-[0_20px_50px_-35px_rgba(0,0,0,0.85)]">
        ...
        <section className="grid grid-cols-1 lg:grid-cols-3 gap-4">
          <div className="p-6 rounded-[2rem] border border-border bg-card-bg/70 shadow-[0_20px_50px_-35px_rgba(0,0,0,0.85)] space-y-3">
            ...
            <ul className="text-sm text-primary space-y-2">
              <li><span className="text-primary font-semibold">Incidents:</span> 2-12 per year</li>
              <li><span className="text-primary font-semibold">Legacy MTTR:</span> 2-12 hours</li>
              <li><span className="text-primary font-semibold">Arista MTTR:</span> 0.25-1 hour</li>
              <li><span className="text-primary font-semibold">Cost/hour:</span> $25k-$500k+</li>
            </ul>
          </div>
          <div className="p-6 rounded-[2rem] border border-border bg-card-bg/70 shadow-[0_20px_50px_-35px_rgba(0,0,0,0.85)] space-y-3">
        ...
        <section className="p-8 rounded-[2.5rem] border border-border bg-card-bg/80 space-y-5 shadow-[0_25px_60px_-40px_rgba(0,0,0,0.85)]">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            <div className="p-5 rounded-2xl border border-border bg-page-bg/60 space-y-2">
              <p className="text-[11px] font-mono text-secondary uppercase tracking-widest">Legacy Loss</p>
              <p className="text-sm text-primary font-mono">Incidents/Year x Legacy MTTR x Cost/Hour</p>
            </div>
            <div className="p-5 rounded-2xl border border-border bg-page-bg/60 space-y-2">
              <p className="text-[11px] font-mono text-secondary uppercase tracking-widest">Arista Loss</p>
              <p className="text-sm text-primary font-mono">Incidents/Year x Arista MTTR x Cost/Hour</p>
            </div>
          </div>
          <div className="p-5 rounded-2xl border border-border bg-page-bg/60 space-y-2">
            <p className="text-[11px] font-mono text-secondary uppercase tracking-widest">Avoided Loss</p>
            <p className="text-sm text-primary font-mono">Legacy Loss - Arista Loss</p>
            <p className="text-xs text-secondary">Equivalent to the yearly insurance effect of faster recovery.</p>
          </div>
        </section>
        ...
        <section className="p-8 rounded-[2.5rem] border border-border bg-card-bg/90 shadow-[0_25px_60px_-40px_rgba(0,0,0,0.85)]">
          ...
          <p className="text-base md:text-lg text-primary leading-relaxed mt-3">
