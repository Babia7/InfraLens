  ...
  return (
    <div className="min-h-screen bg-page-bg text-primary flex flex-col relative overflow-hidden">
      ...
      <header className="h-16 border-b border-border flex items-center justify-between px-6 bg-card-bg/90 backdrop-blur z-20 shadow-[0_10px_30px_-22px_rgba(0,0,0,0.9)]">
        <div className="flex items-center gap-6">
          ...
          <div className="flex items-center gap-3">
            ...
            <div>
              <h1 className="app-header-title">Sales Playbook Coach</h1>
              <span className="app-header-subtitle">Vertical-ready talk tracks</span>
            </div>
          </div>
        </div>
        {onNavigate && (
      ...
      <main className="flex-1 p-6 md:p-10 space-y-8 relative z-10">
        ...
        />
        <section className="tool-card-md shadow-[0_25px_60px_-40px_rgba(0,0,0,0.85)] flex flex-col gap-4 md:flex-row md:items-center md:justify-between">
        ...
        <section className="tool-note shadow-[0_18px_40px_-32px_rgba(0,0,0,0.85)] grid grid-cols-1 md:grid-cols-4 gap-3 items-end">
          ...
          {savedDeals.length > 0 && (
            <div className="md:col-span-4 bg-card-bg/70 border border-border rounded-xl p-3 space-y-2">
              <div className="tool-label">Saved Deals</div>
              <div className="flex flex-wrap gap-2">
                {savedDeals.map((d) => (
                  <button
                    key={d.id}
        ...
        <section className="tool-note shadow-[0_18px_40px_-32px_rgba(0,0,0,0.85)] flex flex-wrap gap-3 items-center">
        ...
        {filteredPlays.length === 0 && (
          <div className="tool-card text-secondary">
        ...
        <section className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 gap-6">
          {filteredPlays.map((play) => (
            <div key={play.id} className="tool-card-md shadow-[0_25px_60px_-40px_rgba(0,0,0,0.85)] space-y-5">
              <div className="flex items-start justify-between">
                <div>
                  <p className="tool-label">{play.vertical}</p>
