...
export enum SectionType {
  ...
  CLI_CONVERTER = 'CLI_CONVERTER',
  AI_TRAFFIC_PATTERN_EXPLORER = 'AI_TRAFFIC_PATTERN_EXPLORER',
  PORT_MATH_CALCULATOR = 'PORT_MATH_CALCULATOR',
  AI_NETWORKING_DISCOVERY = 'AI_NETWORKING_DISCOVERY',
  AI_FABRIC_POC_PLANNER = 'AI_FABRIC_POC_PLANNER'
}
